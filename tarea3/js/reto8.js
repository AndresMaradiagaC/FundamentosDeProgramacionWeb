...
function login() {
    ...
    let selectedInstituto = document.getElementById("instituto-select").value;
    ...
    if (error_count == 0) {
        if (user_input == username && pass_input == password) {
            Swal.fire({
                ...
                if (selectedInstituto === "limon") {
                    window.location.href = "https://ucenfotec.ac.cr/";
                } else if (selectedInstituto === "sanjose") {
                    window.location.href = "https://ucenfotec.ac.cr/";
                } else if (selectedInstituto === "cartago") {
                    window.location.href = "https://ucenfotec.ac.cr/";
                }
            });
        } else {
            text = "Datos inválidos, inténtalo nuevamente.";
            validation(text);
        }
    }
}    
